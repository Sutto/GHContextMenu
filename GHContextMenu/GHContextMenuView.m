...
- (void) longPressDetected:(UIGestureRecognizer*) gestureRecognizer
{
    if (gestureRecognizer.state == UIGestureRecognizerStateBegan) {
        ...
        if (self.menuAnchor == GHContextMenuAnchorContainingView) {
            CGRect grFrame = (CGRect )[gestureRecognizer.view.superview convertRect:gestureRecognizer.view.frame toView:self];
            self.longPressLocation = CGPointMake(CGRectGetMidX(grFrame), CGRectGetMidY(grFrame));
